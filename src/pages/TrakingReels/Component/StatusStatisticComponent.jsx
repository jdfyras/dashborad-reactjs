    ...
    mysocket.on('call center status', msg => {
      {
        ...
        setData([
          {
            name: 'AVAILABLE',
            value: msg.statistics.by.status['AVAILABLE'] || 0
          },
          {
            name: 'NOT AVAILABLE',
            value: msg.statistics.by.status['NOT AVAILABLE'] || 0
          },
          { name: 'TALKING', value: msg.statistics.by.status['TALKING'] || 0 },
          {
            name: 'AFTER WORK',
            value: msg.statistics.by.status['AFTER WORK'] || 0
          }
        ])
        console.log('msg', msg)
      }
        ...
        <Grid container spacing={2}>
          <Grid item xs={4}>
            <Card sx={{ maxWidth: 245 }}>
              <CardContent>
                <p>{statistics.by.status.TALKING}</p>
                <p>TALKING</p>{' '}
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={4}>
            <Card sx={{ maxWidth: 245 }}>
              <CardContent>
                <p>{statistics.by.status['NOT AVAILABLE']}</p>
                <p>NOT AVAILABLE</p>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={4}>
            <Card sx={{ maxWidth: 245 }}>
              <CardContent>
                <p>{statistics.by.status['AFTER WORK']}</p>
                <p>AFTER WORK </p>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={4}>
            <Card sx={{ maxWidth: 245 }}>
              <CardContent>
                <p>{statistics.by.status.AVAILABLE}</p>
                <p>AVAILABLE </p>
              </CardContent>
            </Card>
          </Grid>
