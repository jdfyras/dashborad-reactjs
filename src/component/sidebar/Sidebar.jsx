    ...
    <div className="sidebar">
      ...
      <div className="center">
        <ul>
          ...
          {role == "supervisor" && (
            <li>
              <Link to="/historiquedonnees" className="link">
                <HistoryIcon className="icon" />
                <span>Historique donnees</span>
              </Link>
            </li>
          )}
          {(role == "supervisor" || role == "admin") && (
            <li>
              <Link to="/stast" className="link">
                <TimelineIcon className="icon" />
                <span>Traking Data</span>
              </Link>
            </li>
          )}
          ...
          {role == "engineer" && (
            <>
              ...
              <li>
                <Link to="/apparails" className="link">
              ...
              <li>
                <Link to="/apparails/listeApparail" className="link">
                  <AppSettingsAltIcon className="icon" />
                  <span>Liste Apparails</span>
                </Link>
              </li>
              <li>
                <Link to="/reglage" className="link">
