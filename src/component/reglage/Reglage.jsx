      ...
      {selectedZone && (
        ...
        >
          ...
          <form>
            ...
            <button type='button' onClick={handleCreateDevice}>
              Create Device
            </button>
          </form>
        </div>
        ...
        >
          {Object.keys(zoneDetails).map((zoneName, index) => (
            <div
              ...
              className={
                selectedZone === zoneDetails[zoneName] ? 'selectedZone' : ''
              }
            >
              {zoneName === 'Hopital Rabta' && (
                <div style={{ color: 'red', fontSize: 90, fontWeight: 'bold' }}>
                  •
                </div>
              )}
            </div>
